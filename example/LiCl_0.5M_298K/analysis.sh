...
# Run Python script
conda activate ele_machine_dev # your environment name
...
python free_energy_analysis_script.py --base_path $BASE_PATH --nstrides $NSTRIDES --O_radii $O_RADII --Cl_radii $CL_RADII --Li_index $LI_INDEX --T $TEMP &> free_energy_analysis.log
