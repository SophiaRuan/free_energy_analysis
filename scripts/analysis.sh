...
# Adjust the conda source path below and the variables to match your system
# and local conda/miniforge install location. See README.rst "Usage" for
# per-OS setup notes.
# variables
LI_INDEX=2946 # (id-1)!!!
NUMBER_OF_CV=3  # Customize as needed
CONC=0.5
BASE_PATH="../data/LiCl_0.5M_298K"
NSTRIDES=10
SKIP_FRAMES=9
O_RADII=2.65
H_RADII=2.95
...
RESULTS_DIR="../data/LiCl_0.5M_298K/results"
mkdir -p ${RESULTS_DIR}
mv ./*.png ${RESULTS_DIR}/
mv ./*.csv ${RESULTS_DIR}/
mv ./*.pkl ${RESULTS_DIR}/
